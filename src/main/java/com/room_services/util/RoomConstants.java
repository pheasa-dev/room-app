...
public final class RoomConstants {
	...
	public static final String FIELD_LOCATION_COORDINATION = "location.coordination";

	// Amenities & Features
	public static final String FIELD_HAS_FAN = "hasFan";
	public static final String FIELD_HAS_AIR_CORDITIONER = "hasAirConditioner";
	...
	public static final String FIELD_IS_SMOKING_ALLOWED = "hasSmokingAllowed";
	...
	// Operation Info
	public static final String FIELD_DISTANCE_TO_CENDER = "distanceToCenter";
	public static final String FIELD_NEABY_LANDSMARKS = "nearbyLandmarks";

	// Listing & Rental Policy
	public static final String FIELD_IS_UTILITY_INCLUDED = "isUtilityIncluded";
	public static final String FIELD_DEPOSIT_REQURED = "depositRequired";
	...
	public static final String FIELD_HAS_VEDIO_TOUR = "hasVideoTur";
	...
	public static final String FIELD_CREATED_AT = "createAt";
	...
	// Sort_allow_list
	public static final List<String> ALLOWED_SORT_FILDS = List.of(FIELD_NAME, FIELD_PRICE, FIELD_ROOM_SIZE,
			FIELD_LOCATION_CITY, FIELD_LOCATION_DISTRICT, FIELD_VERIFIED_LISTING, FIELD_CREATED_AT);
}
